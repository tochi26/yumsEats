            ...
            <div className='w-[1240px] mx-auto grid md:grid-cols-2'>
                ...
                <div className='flex flex-col justify-center'>
                    ...
                    <p>
                        ...
                        🕒⏰ Worried about waiting? Fret not! DeliFusion keeps you in the loop with real-time updates on your order. From kitchen creation to doorstep delivery, we've got the countdown covered.
                    </p>
